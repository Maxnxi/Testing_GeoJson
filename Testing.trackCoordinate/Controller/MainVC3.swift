...
//            
//            guard let url = Bundle.main.url(forResource: "geo", withExtension: "json") else { fatalError("Unable to get geoJson")}
//            do{
...
//                }
//                
//                self.geoJsonResponse = parsedData
//                
...
//                
//            }catch let err{
//                print("Error #31", err.localizedDescription)
//            }
//            
//                    
//                    
